package com.douglei.tools.instances.parser.expression;

import java.util.LinkedList;
import java.util.Map;

import com.douglei.tools.instances.parser.expression.operator.OperatorType;
import com.douglei.tools.instances.parser.expression.operator.OperatorTypeHandler;
...
public class ExpressionParser {
	...
	public ExpressionParser(String expression, Map<String, Object> map) {
