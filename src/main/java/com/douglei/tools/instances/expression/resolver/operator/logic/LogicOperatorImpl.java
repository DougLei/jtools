package com.douglei.tools.instances.expression.resolver.operator.logic;
...
public abstract class LogicOperatorImpl extends OperatorImpl {
	...
	protected Object executeCalc(Object leftParam, Object rightParam) {
		...
		if(!VerifyTypeMatchUtil.isBoolean(leftParamString)){
		...
		if(!VerifyTypeMatchUtil.isBoolean(rightParamString)){
